...
export const metadata: Metadata = {
  title: "How It Works | Reflect First",
  description:
    "From choosing a format to measuring outcomes, here is how Reflect First works for universities, schools, and organizations.",
};
...
const sections = [
  {
    ...
    description:
      "Reflect First adapts to your institution and audience. Select the delivery model that fits your context.",
    items: [
      ...
      "Facilitator-led delivery -- book a certified Reflect First facilitator to run the session directly",
    ],
  },
  {
    number: "02",
    ...
    items: [
      ...
      "Digital access to all materials via the Reflect First platform",
    ],
  },
  {
    number: "03",
    ...
    items: [
      ...
      "Complete the optional facilitator certification for deeper preparation",
      "Book a certified Reflect First facilitator to deliver on your behalf",
  ...
  },
  {
    ...
    title: "Stay current",
    description:
      "Policy debates move quickly. Reflect First materials are maintained and updated so your sessions remain relevant.",
    items: [
...
export default function HowItWorksPage() {
  return (
    <main>
      <section className="py-20 md:py-24">
        <div className="mx-auto max-w-6xl px-6">
          <SectionIntro
            ...
            description="Reflect First is designed to be straightforward for institutions to adopt and for instructors to deliver. Here is the process from start to finish."
            centered
          />
        </div>
      </section>
        ...
        <div className="mx-auto max-w-6xl space-y-16 px-6">
          {sections.map((section) => (
            ...
            >
              ...
              <div>
                <h3 className="mb-2 font-serif text-2xl">{section.title}</h3>
      ...
      <CTABand
        title="Ready to see Reflect First in action?"
